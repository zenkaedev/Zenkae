...
export function renderDashHome() {
  ...
  const actions = row(
    new ButtonBuilder()
      .setCustomId(DASH.NAV_RECRUIT)
      .setLabel('Recrutamento')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.NAV_EVENTS)
      .setLabel('Eventos')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId(DASH.NAV_ENGAGE)
      .setLabel('Engajamento')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId(DASH.NAV_ADMIN)
...
export function renderRecruitMenu() {
  ...
  const actions = row(
    new ButtonBuilder()
      .setCustomId(DASH.RECRUIT_EDIT_CLASSES)
      .setLabel('Editar Classes')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.RECRUIT_EDIT_FORM)
      .setLabel('Editar Formulário')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.RECRUIT_APPEARANCE)
      .setLabel('Aparência')
      .setStyle(ButtonStyle.Secondary),
  );
...
export function renderEventsMenu() {
  ...
  const actions = row(
    new ButtonBuilder()
      .setCustomId(DASH.EVENTS_CREATE)
      .setLabel('Criar Evento')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.EVENTS_EDIT)
      .setLabel('Editar Evento')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId(DASH.EVENTS_LIST)
      .setLabel('Listar Eventos')
      .setStyle(ButtonStyle.Secondary),
  );
...
export function renderEngageMenu() {
  ...
  const actions = row(
    new ButtonBuilder()
      .setCustomId(DASH.ENGAGE_VOTES)
      .setLabel('Votações')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.ENGAGE_SUGGESTIONS)
      .setLabel('Sugestões')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId(DASH.ENGAGE_RANKING)
      .setLabel('Ranking')
      .setStyle(ButtonStyle.Secondary),
  );
...
export function renderAdminMenu() {
  ...
  const actions = row(
    new ButtonBuilder()
      .setCustomId(DASH.ADMIN_ROLES)
      .setLabel('Cargos')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId(DASH.ADMIN_ANNOUNCEMENTS)
      .setLabel('Anúncios')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId(DASH.ADMIN_INACTIVE)
      .setLabel('Inativos')
      .setStyle(ButtonStyle.Secondary),
  );
